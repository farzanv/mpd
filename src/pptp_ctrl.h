...
{
	"host", PPTP_HOSTNAME_LEN
}, {
	"vend", PPTP_VENDOR_LEN
}, {
	NULL, 0
}
},
...
{
	"phone", PPTP_PHONE_LEN
}, {
	"subaddr", PPTP_SUBADDR_LEN
},
{
	NULL, 0
}
...
},
{
	...
	"dialed", PPTP_PHONE_LEN
},
{
	"dialing", PPTP_PHONE_LEN
}, {
	"subaddr", PPTP_SUBADDR_LEN
},
{
...
extern int 
PptpCtrlInit(PptpGetInLink_t getInLink,
...
extern void 
PptpCtrlInCall(struct pptpctrlinfo *cinfo,
...
extern void 
PptpCtrlOutCall(struct pptpctrlinfo *cinfo,
    struct pptplinkinfo *linfo,
    struct u_addr *locip, struct u_addr *ip,
    in_port_t port, int bearType, int frameType,
    int minBps, int maxBps,
 ...
 */
extern int 
PptpCtrlGetSelfName(struct pptpctrlinfo *cp,
    void *buf, size_t buf_len);
extern int 
PptpCtrlGetPeerName(struct pptpctrlinfo *cp,
    void *buf, size_t buf_len);

#endif					/* #ifndef _WANT_PPTP_FIELDS */
#endif					/* #if !defined(_PPTP_CTRL_H_) ||
					 * defined(_WANT_PPTP_FIELDS) */
