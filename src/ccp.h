...
#define CCP_TY_DCE		25	/* Data Compression in Data
...
struct ccpstate {
	...
	uint32_t recv_resets;		/* Number of ResetReq we have got from
					 * other side */
	uint32_t xmit_resets;		/* Number of ResetReq we have sent to
					 * other side */
