...
struct acl_pool {			/* Pool of used ACL numbers */
	...
	unsigned short acl_number;	/* ACL number given by RADIUS unique
					 * on this interface */
	unsigned short real_number;	/* Real ACL number unique on this
					 * system */
...
#ifdef USE_IPFW
extern struct acl_pool *rule_pool;	/* Pointer to the first element in the
					 * list of rules */
extern struct acl_pool *pipe_pool;	/* Pointer to the first element in the
					 * list of pipes */
extern struct acl_pool *queue_pool;	/* Pointer to the first element in the
					 * list of queues */
extern struct acl_pool *table_pool;	/* Pointer to the first element in the
					 * list of tables */
extern int rule_pool_start;		/* Initial number of ipfw rules pool */
extern int pipe_pool_start;		/* Initial number of ipfw dummynet
					 * pipe pool */
extern int queue_pool_start;		/* Initial number of ipfw dummynet
					 * queue pool */
