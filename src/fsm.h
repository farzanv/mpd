...
#define CODE_RESETACK		15
 ...
 /*
  * XXX This should be extended to contain more descriptive information XXX
  * about the cause of the failure, like what the rejected protocol XXX or
  * option was, etc.
  */
enum fsmfail {
	...
	FAIL_ECHO_TIMEOUT,		/* peer not responding to echo
					 * requests */
	FAIL_CANT_ENCRYPT		/* failed to negotiate required
					 * encryption */
};
