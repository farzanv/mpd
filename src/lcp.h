...
struct lcpstate {
	...
	LcpAuthProto peer_protos[LCP_NUM_AUTH_PROTOS];	/* list of acceptable
							 * auth-protos */
	...
	LcpAuthProto want_protos[LCP_NUM_AUTH_PROTOS];	/* list of requestable
							 * auth-protos */
...
#define TY_COBS		25		/* Consistent Overhead Byte Stuffing
					 * (COBS) */
